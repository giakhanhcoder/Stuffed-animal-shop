                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0 ms-lg-4">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                <c:forEach items="${listC}" var="o">
                                    <li><a class="dropdown-item" href="category?cid=${o.id}">${o.name}</a></li>
                                    </c:forEach>
                            </ul>
                        </li>
                        ...
                        <c:if test="${sessionScope.acc != null}">
                            <li class="nav-item"><a class="nav-link active" aria-current="page" href="#">Welcome ${sessionScope.acc.name}</a></li>
                            </c:if>
                        ...
                        <div class="dropdown">
                            ...
                            <div class="dropdown-content">
                                ...
                                <c:if test="${sessionScope.acc.role == 2}">
                                    <a href="purchasehistory?id=${sessionScope.acc.id}">Purchase history</a>
                                </c:if>
