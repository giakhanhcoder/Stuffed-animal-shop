<%-- 
    ...
    Created on : Mar 5, 2024, 11:36:03 PM
    Author     : GIA KHANH
--%>
        ...
        <div class="container mt-5">
            ...
            <form action="changepassword" method="post">
                ...
                <div class="mb-3">
                    ...
                    <input type="password" class="form-control" id="name" name="oldpassword" value="${sessionScope.acc.password}">
                </div>

                <div class="mb-3">
                    <label for="name" class="form-label">New passwrod: </label>
