...
out.println("                        <div class=\"product col mb-5\">\n"
        ...
        + "                                        <!-- Product name-->\n"
        + "                                        <h5 class=\"fw-bolder\">" + o.getName() + "</h5>\n"
        + "                                        <!-- Product price-->\n"
        + "                                        $" + o.getPrice() + "\n"
        + "                                    </div>\n"
        + "                                </div>\n"
        ...
        + "                                    <div class=\"text-center\">\n"
        + "                                        <a class=\"btn btn-outline-success\" href=\"detail?pid=" + o.getId() + "\">View detail</a>\n"
        + "                                    </div>\n");
if ((o.getQuantity() == 0)) {
    out.println("                                    <div class=\"text-center\">\n"
            + "                                        <a class=\"btn btn-outline-danger\">Out of stock</a>\n"
            + "                                    </div>\n");
} else if ((o.getQuantity() > 0) && ((acc == null) || (acc.getRole() == 2))) {
    out.println("                                    <div class=\"text-center\">\n"
            + "                                        <a class=\"btn btn-outline-info\" href=\"add-to-cart?id=" + o.getId() + "\">Add to cart</a>\n"
            + "                                    </div>\n");
}
out.println("                                </div>\n"
        + "                            </div>\n"
