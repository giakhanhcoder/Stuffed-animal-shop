            ...
            <div class="container px-4 px-lg-5 my-5">
                <div class="row gx-4 gx-lg-5 align-items-center">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="fs-5 mb-5">
                            <span>Price: $${detail.price}</span><br>
                            ...
                            <c:if test="${acc.role == 2 || acc == null}">
                                <c:if test="${detail.quantity > 0}">
                                    <button class="btn btn-outline-info flex-shrink-0" type="button">
                                        ...
                                        <a href="add-to-cart?id=${detail.id}">Add to cart</a>
                                    </button>
                                </c:if>
                            </c:if>
                        ...
                        <div class="product col mb-5">
                            <div class="card h-100">
                                ...
                                <div class="card-footer p-4 pt-0 border-top-0 bg-transparent d-flex justify-content-between align-items-center">
                                    <div class="text-center">
                                        <a class="btn btn-outline-success mt-auto" href="detail?pid=${o.id}">View detail</a>
                                    </div>
                                    <div>
                                        ...
                                        <c:if test="${acc.role == 2 || acc == null}">
                                            <c:if test="${o.quantity > 0}">
                                                <a class="btn btn-outline-info" href="add-to-cart?id=${o.id}">Add to cart</a>
                                            </c:if>
                                        </c:if>
                                    </div>
                                </div>
